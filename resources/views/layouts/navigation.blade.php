<nav class="navbar navbar-expand-lg navbar-dark px-4">
    ...
    <div class="collapse navbar-collapse" id="navbarEnvycom">
        ...
        <div class="d-flex flex-column flex-lg-row align-items-lg-center gap-3 mt-3 mt-lg-0">
            ...
            <form action="{{ route('productos.buscar') }}" method="GET" class="d-flex" style="min-width: 350px;">
                <input 
                    type="text" 
                    name="search" 
            ...
            <div class="d-flex flex-column flex-lg-row gap-2">
                ...
                @auth
                    <div class="dropdown">
                        <button class="btn btn-envy dropdown-toggle px-4 w-100 text-dark" type="button" id="userMenu" data-bs-toggle="dropdown" aria-expanded="false">
                            Hola, {{ Auth::user()->name }}
                        </button>
                ...
                @else
                    <a href="{{ route('login') }}" class="btn btn-envy px-4 text-nowrap text-center text-dark">Iniciar sesión</a>
                @endauth
            </div>
        </div>
    </div>
