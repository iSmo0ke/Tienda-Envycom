...
<div id="carruselProductos" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner px-4 pb-4">
     ...
     style="height: 150px; object-fit: contain;">
                                ...
                                <h6 class="mt-auto text-uppercase text-muted" style="font-size: 0.8rem;">{{ $producto->marca }}</h6>
                                <p class="small text-dark fw-bold mb-2">{{ $producto->nombre }}</p>
                                <h5 class="text-primary">${{ number_format($producto->precio, 2) }}</h5>
                                
                                <button class="btn btn-envy w-100 mt-2 text-dark">Agregar</button>
                            </div>
                        </div>
                    @endforeach
    ...
    <button class="carousel-control-prev" type="button" data-bs-target="#carruselProductos" data-bs-slide="prev" style="width: 40px; justify-content: flex-start;">
        <span class="carousel-control-prev-icon bg-dark rounded-circle p-2" aria-hidden="true"></span>
        <span class="visually-hidden">Anterior</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carruselProductos" data-bs-slide="next" style="width: 40px; justify-content: flex-end;">
...
<div class="text-center mt-5">
    <a href="{{ route('productos.buscar') }}" class="btn btn-outline-dark px-5 py-2 fw-bold" style="border-radius: 8px;">
...
@php
    $servicios = [
        [
            'titulo' => 'Hardware',
            'icono'  => 'bi-pc-display',
            'texto'  => 'Suministramos hardware de alto rendimiento para todas las necesidades de tu empresa. Desde estaciones de trabajo y laptops de última generación hasta servidores robustos.'
        ],
        [
            'titulo' => 'Impresión y Digitalización',
            'icono'  => 'bi-printer',
            'texto'  => 'Soluciones integrales de impresión láser, inyección de tinta y sistemas de gran formato. Ofrecemos equipos eficientes que reducen costos operativos por página.'
        ],
        [
            'titulo' => 'Software y Licenciamiento',
            'icono'  => 'bi-windows',
            'texto'  => 'Venta y gestión de licencias originales para Microsoft 365, sistemas operativos, antivirus, y herramientas de productividad. Te asesoramos para elegir el esquema que mejor se adapte al tamaño de tu organización.'
        ],
        [
            'titulo' => 'Redes y Conectividad',
            'icono'  => 'bi-router',
            'texto'  => 'Diseño e implementación de infraestructura de red local (LAN) y Wi-Fi empresarial. Configuramos routers, switches y firewalls para asegurar que tu conexión sea estable, rápida y segura contra intrusiones.'
        ],
        [
            'titulo' => 'Mantenimiento Preventivo y Correctivo',
            'icono'  => 'bi-tools',
            'texto'  => 'Extendemos la vida útil de tu inversión mediante pólizas de mantenimiento programado. Limpieza física, optimización de sistema y actualización de hardware.'
        ]
    ];
@endphp
    ...
    @foreach(['Dell','HP','Asus','Benq','Apple'] as $marca)
        <div class="col-6 col-md-2">
            ...
            <div class="brand-card d-flex align-items-center justify-content-center" style="height: 100px;">
                ...
                <img src="{{ asset('img/' . strtolower($marca) . '-logo.png') }}" 
                     alt="Logo de {{ $marca }}" 
                     class="img-fluid" 
