        ...
        <div class="payment-card">
            ...
            <form action="{{ route('checkout.process') }}" method="POST" id="payment-form">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <label class="label-b2b">Nombre</label>
                        <input type="text" class="form-control form-control-custom"
                            data-openpay-card="holder_name" required>
                    </div>

                    <div class="col-12">
                        <label class="label-b2b">Tarjeta</label>
                        <input type="text" class="form-control form-control-custom"
                            data-openpay-card="card_number" maxlength="19" required>
                    </div>

                    <div class="col-md-4">
                        <label class="label-b2b">Mes</label>
                        <input type="text" class="form-control form-control-custom"
                            data-openpay-card="expiration_month" maxlength="2" required>
                    </div>

                    <div class="col-md-4">
                        <label class="label-b2b">Año</label>
                        <input type="text" class="form-control form-control-custom"
                            data-openpay-card="expiration_year" maxlength="2" required>
                    </div>

                    <div class="col-md-4">
                        <label class="label-b2b">CVV</label>
                        <input type="password" class="form-control form-control-custom"
                            data-openpay-card="cvv2" maxlength="4" required>
                    </div>
                ...
                <button type="submit" id="pay-button"
                    class="btn w-100 mt-4 py-3 fw-bold"
                    style="background:#25D366; border:none;">
                    <i class="bi bi-lock-fill"></i> Pagar Pedido
                </button>
